...
export default function MyPage() {
  ...
  return <main className="page account-page"><section className="hero-panel"><div><h1>마이페이지</h1></div><div className="activity-summary"><strong>{data.posts.length}<small>작성한 글</small></strong><strong>{data.comments.length}<small>작성한 댓글</small></strong></div></section>
